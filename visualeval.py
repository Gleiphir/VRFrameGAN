...
G.load_state_dict(torch.load("nets/crop-Jan20/G_500",map_location=torch.device('cuda:0')))

import matplotlib.pyplot as plt

lossrecD = np.load("nets/crop-Jan20/lossD.npy")
lossrecG = np.load("nets/crop-Jan20/lossG.npy")
